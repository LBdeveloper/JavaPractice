...
public class ClientsManager{
	...
	public static void brodcastMsg(String msg) {
	...
	private static void sendMsg(Socket socket, String msg, Iterator<Socket> iter){
		OutputStreamWriter ost = null;
		PrintWriter pw = null;
	...
	public static void closeIO(OutputStreamWriter ost, PrintWriter pw, Socket socket) {
		try {
				if (null != ost) {
					ost.close();
				}
